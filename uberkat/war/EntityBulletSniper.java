...
public class EntityBulletSniper extends EntityBullet
{
    ...
    {
        world.makeSound(this, ((ItemGun)mod_ModernWarfare.itemGunSniper).firingSound, ((ItemGun)mod_ModernWarfare.itemGunSniper).soundRangeFactor, 1.0F / (random.nextFloat() * 0.1F + 0.95F));
    }
}
