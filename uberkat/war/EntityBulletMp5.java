...
public class EntityBulletMp5 extends EntityBullet
{
    ...
    {
        world.makeSound(this, ((ItemGun)mod_ModernWarfare.itemGunMp5).firingSound, ((ItemGun)mod_ModernWarfare.itemGunMp5).soundRangeFactor, 1.0F / (random.nextFloat() * 0.1F + 0.95F));
    }
}
