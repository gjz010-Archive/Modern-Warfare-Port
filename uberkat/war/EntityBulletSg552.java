...
public class EntityBulletSg552 extends EntityBullet
{
    ...
    {
        world.makeSound(this, ((ItemGun)mod_ModernWarfare.itemGunSg552).firingSound, ((ItemGun)mod_ModernWarfare.itemGunSg552).soundRangeFactor, 1.0F / (random.nextFloat() * 0.1F + 0.95F));
    }
}
