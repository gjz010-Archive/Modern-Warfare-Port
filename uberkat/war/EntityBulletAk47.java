...
public class EntityBulletAk47 extends EntityBullet
{
    ...
    {
        world.makeSound(this, ((ItemGun)mod_ModernWarfare.itemGunAk47).firingSound, ((ItemGun)mod_ModernWarfare.itemGunAk47).soundRangeFactor, 1.0F / (random.nextFloat() * 0.1F + 0.95F));
    }
}
